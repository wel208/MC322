public class Troll extends Monstro {
    ...
    public void ambientarMonstro(Heroi heroi){
        System.out.println("\nO chão treme com passos pesados..."); Utilidades.esperar(2000);
        System.out.println("Das sombras surge um enorme Troll, com pele grossa e olhar faminto."); Utilidades.esperar(2000);
        System.out.println("Sua respiração é pesada e ele segura um tronco como se fosse uma clava."); Utilidades.esperar(2000);

        System.out.printf("\n%s, o TROLL, no nível %d de dificuldade, possui:", nome, nivelDificuldade); Utilidades.esperar(2000);
        ...
        System.out.println("\nO herói percebe que terá de usar estratégia para vencer essa criatura."); Utilidades.esperar(1500);
    }
