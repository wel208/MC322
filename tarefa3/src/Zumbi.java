public class Zumbi extends Monstro {
    ...
    public void ambientarMonstro(Heroi heroi){
        System.out.println("\nUm cheiro pútrido invade o ar..."); Utilidades.esperar(200);
        System.out.println("Das sombras, surge um Zumbi cambaleante, com pedaços de carne pendendo de seu corpo."); Utilidades.esperar(200);
        System.out.println("Seus olhos sem vida fixam-se no herói, e um grunhido gutural ecoa."); Utilidades.esperar(200);

        System.out.printf("\n%s, o ZUMBI, no nível %d de dificuldade, possui:", nome, nivelDificuldade); Utilidades.esperar(200);
        ...
        System.out.println("\nO herói percebe que não será fácil derrubar essa criatura."); Utilidades.esperar(200);
    }
        ...
        for (int i = 0; i < arma.attackSpeed; i++){
            if (Math.random() > alvo.dodgeChance){
                ...
                if (Math.random() < criticalChance){
                    ...
                    System.out.println("O Zumbi desfere um golpe CRÍTICO com suas garras!"); Utilidades.esperar(200);
                } else {
                    alvo.receberDano(forca * arma.dano);
                    System.out.println("O Zumbi acerta um golpe pesado no herói!"); Utilidades.esperar(200);
                }
            } else {
