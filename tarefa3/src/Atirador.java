        ...
        for (int i = 0; i < arma.getAttackSpeed(); i++) {
            ...
            if (Math.random() < chanceAcerto) {
                ...
                if (Math.random() > alvo.getDodgeChance()){
                    ...
                    System.out.println("NAO! O inimigo ESQUIVOU do ataque!"); Utilidades.esperar();
                }
            }
            else{
                System.out.println("NAO! O atirador ERROU o ataque!"); Utilidades.esperar();
            }
        }
        ...
        for (int i = 0; i < qtdAtque; i++){
            ...
            if (Math.random() < chanceAcerto){
                ...
                if (Math.random() > alvo.getDodgeChance()){
                    ...
                    System.out.println("ISSO! O nosso atirador ACERTOU o inimigo!"); Utilidades.esperar();
                }
                else{
                    System.out.println("NAO! O inimigo ESQUIVOU do projetil do nosso atirador!"); Utilidades.esperar();
                }
            }
            else
                System.out.println("NAO! O atirador ERROU o projetil!"); Utilidades.esperar();
        }

        System.out.printf("\nO heroi acertou %d projeteis de %d projeteis atirados!", contador, qtdAtque); Utilidades.esperar();
    }
